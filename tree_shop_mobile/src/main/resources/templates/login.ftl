		...
		<div class="nl-content">
			...
			<div class="nl-frame-container">
				<div class="ng-form-area show-place" id="form-area">
					<form method="post" action="/mobile/user/login" id="miniLogin"
                        ...
                        <div class="ng-link-area" style="margin-top: 10px">
								<span> <a
                            ...
                            <span> <a
                                        href="/mobile/user/2register"
                                        id="other_method_default">注册账号</a><span> | </span>
								</span>
